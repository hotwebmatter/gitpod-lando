...
RUN curl -OL https://github.com/lando/lando/releases/download/v3.6.2/lando-x64-v3.6.2.deb && sudo dpkg -i --ignore-depends docker-ce,iptables lando-x64-v3.6.2.deb && rm -rf lando-x64-v3.6.2.deb
